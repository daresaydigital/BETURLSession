...
@interface NSArray (SIHTTPCoreSerializers)
-(void)SIHTTPCore_recursivelyRemoveNulls;
@end

@interface NSDictionary (SIHTTPCoreSerializers)
-(void)SIHTTPCore_recursivelyRemoveNulls;
@end
...
-(void)buildObjectForResponse:(NSURLResponse *)theResponse
  ...
  [self validateResponse:(NSHTTPURLResponse *)theResponse data:theResponseData onCompletion:^(id obj, NSError *error) {
    ...
    if(theResponseData){
      ...
      if(self.withoutNull && JSONParseError == nil) [theResponseObject SIHTTPCore_recursivelyRemoveNulls];
...
@implementation NSMutableDictionary (SIHTTPCoreSerializers)
...
-(void)SIHTTPCore_recursivelyRemoveNulls; {
  ...
  [arrayKeys enumerateObjectsUsingBlock:^(id obj, __unused NSUInteger idx, __unused BOOL *stop) {
    ...
    [arrayToCleanse SIHTTPCore_recursivelyRemoveNulls];
  }];
  ...
  [dictionaryKeys enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
    ...
    [dictionaryToCleanse SIHTTPCore_recursivelyRemoveNulls];
  }];
...
@implementation NSMutableArray (SIHTTPCoreSerializers)
...
-(void)SIHTTPCore_recursivelyRemoveNulls; {
  ...
  [[self objectsAtIndexes:arrayIndexes] enumerateObjectsUsingBlock:^(NSMutableArray * obj, __unused NSUInteger idx, __unused BOOL *stop) {
    [obj SIHTTPCore_recursivelyRemoveNulls];
  }];
